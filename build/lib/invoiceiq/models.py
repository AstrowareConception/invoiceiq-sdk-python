...
class GenerationInvoiceLine(BaseModel):
    id: Optional[str] = None
    name: str
    description: Optional[str] = None
    quantity: float
...
class GenerationTaxSummary(BaseModel):
    taxRate: Optional[float] = None
...
class GenerationPayload(BaseModel):
    ...
    seller: PartyDetail
    buyer: PartyDetail
    lines: Optional[List[GenerationInvoiceLine]] = None
    totalTaxExclusiveAmount: float
    taxTotalAmount: float
    totalTaxInclusiveAmount: float
    taxSummaries: Optional[List[GenerationTaxSummary]] = None
    notes: Optional[str] = None
